...
Public Function Activalayer(nombre As Variant)
    ...
    LayerName.Freeze = False
    LayerName.LayerOn = True
...
Public Function lineaMS(nombre As Variant, StartX As Variant, StartY As Variant, StartZ As Variant, EndX As Variant, EndY As Variant, EndZ As Variant, Color As Variant, layer As Variant)
